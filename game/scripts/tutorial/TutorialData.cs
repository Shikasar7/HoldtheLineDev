...
public static class TutorialData
{
    ...
    public static List<TutStep> Script() => new()
    {
        ...
        Narration("欢迎来到守线",
            "这是一场卡牌与战旗交织的战斗:出牌部署随从,再像战棋一样走位、攻击。你执[b]铁誓军团[/b],先手。"),
        Deploy(Squire, SquireHome, "部署随从",
            "把[b]誓火侍从[/b]拖到高亮的前线格。随从只能部署在你的底线行。"),
        EndTurn("你这回合能做的都做完了——点[b]结束回合[/b]把行动权交给对方。"),
        ...
        Narration("轮到我们反击", "站稳了脚跟,该我们组织防线、稳步向前了。"),
        ...
        AttackLeader(SquarePush, "直捣黄龙",
            "月影猎后很强,我们大可用射程消耗 + 持盾慢慢磨死它——但此刻有更妙的选择:[b]直捣黄龙[/b]!誓火侍从已站在对方底线,直接[b]攻击本体[/b],终结战斗!"),
    };
}
